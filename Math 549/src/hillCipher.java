public class hillCipher {
	public static void main(String[] args){
		String cipher = "";
		for(int i = 0; i < 26; i++){
			for(int j = 0; j < 26; j++){
				for(int k = 0; k < 26; k++){
					for(int l = 0; l < 26; l++){
